    ...
    $.Jcrop = function (obj, opt) {
        ...
        var Coords = function () {
            ...
            function getFixed() {
                ...
                var aspect = options.aspectRatio, min_x = options.minSize[0] / xscale, min_y = options.minSize[1] / yscale, max_x = options.maxSize[0] / xscale, max_y = options.maxSize[1] / yscale,
                    rw = x2 - x1, rh = y2 - y1, rwa = Math.abs(rw), rha = Math.abs(rh), real_ratio = rwa / rha, xx, yy;
                if (max_x == 0) {
                    max_x = boundx * 10
                }
                if (max_y == 0) {
        ...
        var Selection = function () {
            ...
            function moveHandles(c) {
                ...
                "e" in handle && handle.e.css({top: px(midvert), left: px(east)}) && handle.w.css({top: px(midvert)}) && handle.s.css({
                    top: px(south),
                    left: px(midhoriz)
            ...
            disableHandles();
            return {
                updateVisible: updateVisible, update: update, release: release, refresh: refresh, setCursor: function (cursor) {
    ...
    $.fn.zyPopup = function (options, param) {
        ...
        return this.each(function () {
            ...
            this.openPopup = function () {
                ...
                function render() {
                    var image = $(this), borderWidth = parseInt(zoomContent.css("borderLeftWidth")), maxImageWidth = windowWidth - (borderWidth * 2), maxImageHeight = windowHeight - (borderWidth * 2),
...
var ZYFILE = {
    fileInput: null, uploadInput: null, dragDrop: null, url: "", uploadFile: [], lastUploadFile: [], perUploadFile: [], fileNum: 0, filterFile: function (files) {
        return files
        ...
        /*console.info("继续选择");console.info(this.uploadFile);*/
        return this
        ...
        /*console.info("还剩这些文件没有上传:");console.info(this.uploadFile);*/
        return true
        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '							<img class="upload_image" src="../../layui2.0/lib/jq-module/zyupload/images/add_img.png" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "						</div>";
                    html += "					</a>";
                    html += "				</div>";
                    html += "			</div>";
            ...
            this.createPopupPlug = function (imgSrc, index, name) {
                $("body").zyPopup({
                    src: imgSrc, index: index, name: name, onTailor: function (val, quondamImgInfo) {
                        ...
                        $("#uploadImage_" + index).css({"width": width, "height": height, "margin-left": -left, "margin-top": -top});
            ...
            this.createCorePlug = function () {
                var params = {
                    fileInput: $("#fileImage").get(0), uploadInput: $("#fileSubmit").get(0), dragDrop: $("#fileDragArea").get(0), url: $("#uploadForm").attr("action"), filterFile: function (files) {
                        ...
                        /*console.info("剩下的文件");console.info(files)*/
                    }, onProgress: function (file, loaded, total) {
