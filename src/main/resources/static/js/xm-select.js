...
!function (e) {
    ...
    105: function (e, t) {
        ...
        function j(e, t, n, o, r) {
            var i = {type: e, props: t, key: n, ref: o, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: r};
        ...
        var te = function (e) {
            ...
            return t = i, (n = [{
                ...
                key: "render", value: function (e) {
                    var t = this, n = e.data, o = e.prop, r = e.theme, i = e.model, a = e.sels, l = e.autoRow, s = e.tree, c = o.name, u = o.disabled, f = i.label, d = f.type, m = f[d], b = a;
                    ...
                    if ("text" === d) y = b.map((function (e) {
                        ...
                        y = g.splice(0, w).map((function (e) {
                            ...
                            return S("div", {class: ["xm-label-block", e[u] ? "disabled" : ""].join(" "), style: _}, m.template && p(m.template) ? S("span", {
                                style: n,
                                dangerouslySetInnerHTML: {__html: m.template(e, g)}
                            }) : S("span", {style: n}, e[c]), m.showIcon && S("i", {class: "xm-iconfont xm-icon-close", onClick: t.iconClick.bind(t, e, !0, e[u])}))
                    ...
                    }, x ? S("div", {class: "label-content", dangerouslySetInnerHTML: {__html: y}}) : S("div", {class: "label-content", title: v}, y)))
                }
        ...
        var pe = {}, fe = function (e) {
            ...
            return t = i, (n = [{
                ...
                key: "render", value: function (e) {
                    var t, n = this, o = e.data, r = e.flatData, i = e.prop, a = e.template, l = e.theme, s = e.radio, c = e.sels, u = e.empty, h = e.filterable, m = e.filterMethod,
                        b = e.remoteSearch, y = (e.remoteMethod, e.delay, e.searchTips), x = e.create, v = e.pageRemote, g = e.max, _ = e.enableKeyboard, w = i.name, k = i.value, C = i.disabled,
                        O = i.children, j = i.optgroup, E = f([], r);
                    ...
                    if (e.paging) {
                        ...
                        }, e.languageProp.paging.prev), S("span", null, this.state.pageIndex, " / ", T), S("span", {style: B, onClick: this.pageNextClick.bind(this, T)}, e.languageProp.paging.next))
                    ...
                    return (E = E.map((function (t) {
                        return t[j] ? t.__tmp ? S("div", {class: "item--divided"}) : S("div", {class: "xm-group"}, S("div", {
                            ...
                            return S("div", {class: d, style: u, value: t[k], onClick: n.optionClick.bind(n, t, r, t[C]), onMouseEnter: m, onMouseLeave: m}, Z && S("i", {
                                class: h,
                                style: i
                            }), S("div", {class: "xm-option-content", dangerouslySetInnerHTML: {__html: a({data: o, item: t, arr: c, name: t[w], value: t[k]})}}))
                        }(t)
        ...
        var ve = function (e) {
            ...
            return t = i, (n = [{
                ...
                key: "render", value: function (e) {
                    return this.prepare = !0, S("div", {onClick: this.blockClick, class: "xm-body-custom"}, S("div", {
                        class: "scroll-body",
                        style: {maxHeight: e.height}
                    }, S("div", {style: "margin: 5px 0", dangerouslySetInnerHTML: {__html: e.content}})))
                }
        ...
        var Se = {}, je = function (e) {
            ...
            function i(e) {
                ...
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, i), (t = r.call(this, e)).state = {expandedKeys: [], filterValue: "", remote: !0, loading: !1, val: Se}, t.searchCid = 0, t.inputOver = !0, t.__value = "", t.tempData = [], t
            }
            ...
            return t = i, (n = [{
                ...
                key: "componentWillReceiveProps", value: function (e) {
                    ...
                    this.props.show != e.show && (e.show ? setTimeout((function () {
                        return t.focus()
                    }), 0) : (this.setState({filterValue: "", val: Se}), this.__value = "", this.searchInputRef && (this.searchInputRef.value = "")))
                }
            }, {
                ...
                key: "render", value: function (e, t) {
                    var n = this, o = (t.expandedKeys, e.prop), r = e.empty, i = e.sels, a = e.theme, l = e.radio, s = e.template, c = e.data, u = e.tree, h = e.filterable, m = e.remoteSearch,
                        b = e.searchTips, y = e.iconfont, x = e.enableKeyboard, v = o.name, g = o.value, _ = o.disabled, w = o.children, k = o.optgroup, C = "hidden" != e.model.icon,
                        O = function (e, t, o) {
                            ...
                            var m = ["xm-option", p ? " disabled" : "", r ? " selected" : "", C ? "show-icon" : "hide-icon"].join(" "),
                                ...
                                k = ["xm-tree-icon", o ? "expand" : "", e[w] && (e[w].length > 0 || u.lazy && !1 !== e.__node.loading) ? "xm-visible" : "xm-hidden"].join(" "), O = [];
                            u.showFolderIcon && (O.push(S("i", {class: k, type: "expand"})), u.showLine && (o && O.push(S("i", {
                                class: "left-line",
                                style: {left: t - u.indent + 3 + "px"}
                            })), O.push(S("i", {class: "top-line", style: {left: t - u.indent + 3 + "px", width: u.indent + (0 === o ? 10 : -2) + "px"}}))));
                            var j = function (t) {
                            ...
                            }), S("div", {class: "xm-option-content", dangerouslySetInnerHTML: {__html: s({data: c, item: e, arr: i, name: e[v], value: e[g]})}}))
                        };
                    ...
                    var P = S("div", {class: "xm-toolbar"}, e.toolbar.list.map((function (t) {
                        ...
                        return e
                    }))), I = S("div", {class: h ? "xm-search" : "xm-search dis"}, S("i", {class: "xm-iconfont xm-icon-sousuo"}), S("input", {class: "xm-input xm-search-input", placeholder: b}));
                    return A.length || A.push(S("div", {class: "xm-select-empty"}, r)), S("div", {
                        onClick: this.blockClick,
                        class: "xm-body-tree"
                    }, e.toolbar.show && P, I, S("div", {class: "scroll-body", style: {maxHeight: e.height}}, A), this.state.loading && S("div", {class: "loading"}, S("span", {class: "loader"})))
                }
            }, {
                key: "componentDidMount", value: function () {
                    var e = this.base.querySelector(".xm-search-input");
        ...
        var Me = function (e) {
            ...
            return t = i, (n = [{
                ...
                key: "render", value: function (e, t) {
                    var n = this, o = e.prop, r = e.empty, i = e.sels, a = e.theme, l = e.radio, s = e.template, c = e.data, u = e.cascader, p = o.name, f = o.value, d = o.disabled, h = o.children,
                        m = "hidden" != e.model.icon, b = [], y = function t(o, r, y) {
                            ...
                            return v && b.push(S("div", {
                                ...
                                var g = y ? {color: a.color, border: "none"} : {borderColor: a.color}, _ = t[h] && t[h].length > 0, w = {backgroundColor: "transparent"},
                                ...
                                return S("div", {class: k, style: w, value: t[f], onClick: n.optionClick.bind(n, t, y, x, "line", r), onMouseEnter: E, onMouseLeave: E}, m && S("i", {
                                    class: C,
                                    style: g,
        ...
        var Qe = function (e) {
            ...
            return t = i, (n = [{
                ...
                key: "upDate", value: function (e, t) {
                    var n = this.state.dataObj, o = this.props, r = o.prop, i = o.tree, a = o.cascader, l = r.value, s = r.disabled, c = r.children;
                    e.map((function (e) {
                ...
                key: "exchangeValue", value: function (e) {
                    var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.state.dataObj, o = this.props, r = o.prop, i = o.tree, a = o.cascader,
                        l = (o.data, r.children), s = r.value, c = e.map((function (e) {
                ...
                key: "load", value: function (e, t, n, o) {
                    var r = this, i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, a = arguments.length > 5 ? arguments[5] : void 0, l = this.props, s = l.prop, c = l.tree,
                ...
                key: "resetSelectValue", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                        n = arguments.length > 2 ? arguments[2] : void 0, o = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3], r = this.props.on;
                ...
                key: "checkMax", value: function (e, t) {
                    var n, o = this.props, r = o.max, i = o.maxMethod, a = o.theme, l = (n = r, n -= 0, isNaN(n) && (n = 0), n);
                    if (l > 0 && t.length >= l) return this.updateBorderColor(a.maxColor), i && p(i) && i(t, e), !0
                }
            }, {
                key: "itemClick", value: function (e, t, n, o) {
                    var r = this.props, i = (r.theme, r.prop), a = r.radio, l = r.repeat, s = r.clickClose, c = (r.max, r.maxMethod, r.tree), u = r.data, p = ze(this.state.sels), f = i.value,
                ...
                key: "render", value: function (e, t) {
                    var n = this, o = e.theme, r = e.prop, i = (e.radio, e.repeat, e.clickClose, e.on, e.max, e.maxMethod, e.content), a = e.disabled, l = e.tree, s = {borderColor: o.color},
                        c = t.data, u = t.dataObj, p = t.flatData, f = t.sels, d = t.show, h = t.tmpColor, m = t.bodyClass;
                    a && (d = !1);
                    var b = {style: Fe(Fe({}, e.style), d ? s : {}), onClick: this.onClick.bind(this), ua: -1 != navigator.userAgent.indexOf("Mac OS") ? "mac" : "win", size: e.size, tabindex: 1};
                    ...
                    var y = Fe(Fe({}, e), {}, {
                        ...
                        }), x = Fe(Fe({}, e), {}, {data: c, dataObj: u, flatData: p, sels: f, ck: this.itemClick.bind(this), show: d, onReset: this.onReset.bind(this)}),
                    ...
                    return S("xm-select", b, S("input", {
                        ...
                        class: ["xm-body", m, e.model.type, d ? "" : "dis"].join(" "), style: g, ref: function (e) {
                            return n.bodyView = e
                        }
        ...
        }(A), Je = {tips: "请选择", empty: "暂无数据", searchTips: "请选择", toolbar: {ALL: "全选", CLEAR: "清空", REVERSE: "反选", SEARCH: "搜索"}, paging: {prev: "上一页", next: "下一页"}}, We = {
            zn: Je,
            en: {
        ...
        var ot = function () {
            ...
            return t = e, (n = [{
                ...
                key: "getValue", value: function (e) {
                    var t = this, n = this.options, o = n.tree, r = n.prop, i = n.data, a = st[this.options.el].state.sels, l = a;
